...
ALTER TYPE "Permission" ADD VALUE 'NEW_PATIENTS';
ALTER TYPE "Permission" ADD VALUE 'DELETE_PATIENTS';
ALTER TYPE "Permission" ADD VALUE 'NEW_APPOINTMENTS';
ALTER TYPE "Permission" ADD VALUE 'DELETE_APPOINTMENTS';
